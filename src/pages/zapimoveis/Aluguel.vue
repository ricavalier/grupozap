<template>
  <q-page class="zap-aluguel">
    <home-carousel class="zap-slide" :dadosCarousel="listaCarousel" portal="zapimoveis" v-if="listaCarousel.length > 0"></home-carousel>
    <home-vitrine class="zap-vitrine" :dadosVitrine="dadosImoveis" portal="zapimoveis" titulo="Imóveis para Alugar" v-if="listaCarousel.length > 0"></home-vitrine>
  </q-page>
</template>
