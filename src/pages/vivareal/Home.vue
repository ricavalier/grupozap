<template>
  <q-page class="viva-home">
    <home-carousel class="viva-slide" :dadosCarousel="listaCarousel" portal="vivareal" v-if="listaCarousel.length > 0"></home-carousel>
    <home-vitrine class="viva-vitrine" :dadosVitrine="dadosImoveis" portal="vivareal" titulo="Imóveis" v-if="listaCarousel.length > 0"></home-vitrine>
  </q-page>
</template>
