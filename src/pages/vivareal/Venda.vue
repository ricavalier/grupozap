<template>
  <q-page class="viva-venda">
    <home-carousel class="viva-slide" :dadosCarousel="listaCarousel" portal="vivareal" v-if="listaCarousel.length > 0"></home-carousel>
    <home-vitrine class="viva-vitrine" :dadosVitrine="dadosImoveis" portal="vivareal" titulo="Imóveis para Comprar" v-if="listaCarousel.length > 0"></home-vitrine>
  </q-page>
</template>
